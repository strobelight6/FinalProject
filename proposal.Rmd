...
Since this dataset includes all Division One teams, we will look at which stats correspond with highwer achieving teams. We can do this for all teams and then specifically focus in on Iowa State to see how they perform over the years. It will be very interesting to see over the time period how each team performs and to determine why or why they aren't making it to the end of season tournament. 