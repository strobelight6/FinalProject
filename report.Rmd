...
```{r}
##winsVWAB <- ggplot(big12, aes(x = winPercent, y = WAB)) + geom_point() + geom_smooth(method = 'lm') 
...
TORVWAB <- ggplot(big12, aes(x = TOR, y = WAB)) + geom_point() + geom_smooth(method = 'lm') + xlab("Turnover % Allowed")
FTRVWAB <- ggplot(big12, aes(x = FTR, y = WAB)) + geom_point() + geom_smooth(method = 'lm') + xlab("Free Throw Rate")
